...
optional text can be configured in settings/reading/Chi Enquete Settings Section
...
There is optional html/text for each section that can be configured in the settings/reading/Chi Enquete Settings Section

==For viewing of all surveys==

The plugin has an admin page called Vitality Survey
