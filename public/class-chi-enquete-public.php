...
class Chi_Enquete_Public
{
    ...
    {
        global $survey_obj;
        require_once plugin_dir_path(dirname(__FILE__)) . 'public/chi-survey-new.php';
        require_once plugin_dir_path(dirname(__FILE__)) . 'public/chi-survey-completed.php';
        ...
        if (array_key_exists( 'state',$_POST) && $_POST['state'] == 'start') {
            ...
            if ($code && $dob) {
                ...
                $text = get_option('chi_enquete_not_found_text');
...
// normalize attribute keys, lowercase
        ...
        require_once plugin_dir_path(dirname(__FILE__)) . 'public/partials/chi-enquete-public-start.php';
